...
enable_gradle_release
../gradlew -p ${BASEDIR}/../../android -PreleaseVersionCode=$1 -PreleaseVersionName=$2 -PreleaseMinSdk=21 -PreleaseTargetSdk=29 -PreleaseProject=mobile-ffmpeg-watermark clean publish || exit 1
create_package "watermark" "$2" || exit 1
